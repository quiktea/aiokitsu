class Manga():
    ...
    def serialization(self):
        return self.__attrs.get("serialization")
    ...
    def chapterCount(self):
        return self.__attrs.get("chapterCount")

    @property
    def volumeCount(self):
        return self.__attrs.get("volumeCount")
    ...
    @property
    def mangaType(self):
        return self.__attrs.get("mangaType")
    ...
    @property
    def episodes(self):
        return self.__attrs.get("chapters")
    ...
    def animeCharacters(self):
        return self.__attrs.get("mangaCharacters")

    @property
    def animeStaff(self):
        return self.__attrs.get("mangaStaff")
